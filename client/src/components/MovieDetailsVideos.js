            ...
            <div className="text-center">
                {trailers.map((trailer, i) => (
                    <span className="ml-2" key={i} >
                        <iframe width="450" height="300" src={"https://www.youtube.com/embed/"+trailer.key} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen title={trailer.key}></iframe>
                    </span>
                ))}
            </div>
        </div>
